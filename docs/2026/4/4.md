...
高通海得拉巴招聘Linux/Zephyr软件集成高级工程师,招聘明确要求候选人具备Zephyr/FreeRTOS等RTOS的实战经验，并需担任Zephyr产品集成团队的首要联系人，直接驱动Zephyr在嵌入式设备上的软件启动、组件集成与问题调试

## 技术

1、[如何避免Zephyr BLE 固件中的优先级](https://hubble.com/community/guides/zephyr-thread-priorities-and-scheduling-avoiding-priority-inversion-in-ble-firmware/)
